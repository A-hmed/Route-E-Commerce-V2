...
part of 'commerce_services.dart';
...
class _CommerceServices implements CommerceServices {
  _CommerceServices(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<ProductsResponse> loadProductsByCategory(
    ...
    final _options = _setStreamType<ProductsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/products?category=${categoryId}&category=${subCategoryId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<CategoriesResponse> loadSubCategories(String categoryId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> addProductToCart(AddProductRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<CartResponse> removeProductFromCart(dynamic productId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
